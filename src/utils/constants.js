...
export const picModalWindow = document.querySelector(".profile-image-popup");
...
export const modalOccupationInput =
...
export const editPictureSelector = document.querySelector(
  ".profile-image-popup"
);
export const editProfilePictureButton =
  document.querySelector(".profile__avatar");
export const pictureForm = picModalWindow.querySelector(".form");
